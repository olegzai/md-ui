(function (root) {
  ...
  const TYPE_ALIASES = {
    'кнопка': 'button', 'button': 'button', 'btn': 'button',
    'показать': 'fold', 'fold': 'fold', 'details': 'fold', 'спойлер': 'fold',
    'бар': 'progress', 'progress': 'progress', 'прогресс': 'progress', 'bar': 'progress',
    'вкладки': 'tabs', 'tabs': 'tabs', 'вкладка': 'tab',
    'выбор': 'select', 'select': 'select',
    'ввод': 'input', 'input': 'input', 'поле': 'input',
    'спросить': 'modal', 'modal': 'modal',
    'дерево': 'tree', 'tree': 'tree', 'меню': 'tree',
    'заметка': 'note', 'note': 'note',
    'важно': 'warn', 'warn': 'warn',
  };

  const STYLE_WORDS = {
    'зелёная': 'green', 'зеленая': 'green', 'green': 'green',
    'красная': 'red', 'red': 'red',
    'синяя': 'blue', 'blue': 'blue',
    'жёлтая': 'yellow', 'желтая': 'yellow', 'yellow': 'yellow',
    'большая': 'big', 'big': 'big',
    'диим': 'dim', 'dim': 'dim',
    'примарная': 'primary', 'primary': 'primary',
  };
  ...
  function printHelp() {
    process.stdout.write([
      ...
      '',
      'Виджеты: {Кнопка} · ::: кнопка Запустить зелёная · ::: показать Подробнее',
      '         ::: бар 70 · ::: вкладки А / Б · ::: выбор а / б',
      '         ::: ввод Имя · ::: дерево А / Б · ::: спросить Точно? · - [x]',
      '',
